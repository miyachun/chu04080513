...
app = Flask(__name__)
df = pd.read_csv('static/people111.csv')
...
def index():
    ...
    return render_template("index09.html", xdata=Nlist,ydata01=Alist,ydata02=Blist,ydata03=Clist,ydata04=Dlist,ydata05=Elist,ydata06=Flist,ydata07=Glist,ydata08=Hlist)
